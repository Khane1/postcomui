...
>
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <h3
        class="text-[10px] font-extrabold tracking-widest text-slate-400 uppercase select-none"
      >
        Categories
      </h3>
      <button
    ...
    <nav class="space-y-1" aria-label="Sidebar navigation">
          ...
          >
            ...
            {:else if item.icon === "grocery"}
              ...
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M19.5 3.5a16.5 16.5 0 0 1-5.1 11c-3.1 3.1-7.1 4-9 2s-1.1-5.9 2-9a16.5 16.5 0 0 1 11-5m1.1 1c1 1 1.7 2.7 1.7 4.2a6.4 6.4 0 0 1-1.7 3.8C16.5 13.5 13 14.5 11 14.5"
              />
            {:else if item.icon === "restaurants"}
              ...
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M12 6.25v-1.5m-9 12h18m-18 0a1.5 1.5 0 0 0 1.5 1.5h15a1.5 1.5 0 0 0 1.5-1.5m-18 0c0-4.5 3.582-8 8-8s8 3.5 8 8"
              />
            ...
            {:else if item.icon === "brands"}
              ...
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39 1.593 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.745 3.745 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z"
              />
            {/if}
          </svg>
      ...
      >
        ...
        <svg
          class="w-4 h-4 text-slate-500 transform transition-transform {showAllDepartments
            ? 'rotate-180'
            : ''}"
          fill="none"
          stroke="currentColor"
    ...
    <div class="space-y-1">
      <h3
        class="px-3 text-[14px] font-black text-slate-900 tracking-tight select-none"
      >
        You
      </h3>
  ...
  <div
    class="bg-[#F1EFE9]/40 p-3.5 rounded-xl border border-slate-200/50 mt-auto select-none"
  >
    <p class="text-[9px] font-bold text-slate-400 tracking-wider uppercase">
      ePosta Network
    </p>
    <p class="text-[11px] text-slate-600 font-bold mt-1 leading-snug">
      Flat-rate national postage logistics active.
    </p>
  </div>
</aside>
